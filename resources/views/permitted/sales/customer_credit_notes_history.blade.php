  ...
  <div id="modal_view_poliza" class="modal fade" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <form id="form_save_asientos_contables" name="form_save_asientos_contables" enctype="multipart/form-data">
          {{ csrf_field() }}
      ...
      <div class="card">
        <div class="card-body">
          <div class="table-responsive table-data table-dropdown">
            <table id="table_filter_fact" name='table_filter_fact' class="table table-hover table-condensed table-sm">
              <thead>
                <tr>
                    <th></th>
...
@push('scripts')
  ...
  <script type="text/javascript">
    ...
    var text_status_open = "{{__("customer_credit_note.text_status_open")}}";
    var text_status_paid = "{{__("customer_credit_note.text_status_paid")}}";
    var text_status_cancel = "{{__("customer_credit_note.text_status_cancel")}}";
    var text_status_reconciled = "{{__("customer_credit_note.text_status_reconciled")}}";

    var button_show = "@lang('general.button_show')";
    var button_download_xml = "@lang('general.button_download_xml')";
    var button_send_mail = "@lang('general.button_send_mail')";

    var text_mark_sent = " @lang('customer_credit_note.text_mark_sent')";
    var text_mark_open = "@lang('customer_credit_note.text_mark_open')";
    var text_mark_reconciled = "@lang('customer_credit_note.text_mark_reconciled')";
    var button_status_sat = "@lang('general.button_status_sat')";
    var button_cancel = "@lang('general.button_cancel')";


  </script>
  <script src="{{ asset('js/admin/sales/customer_credit_notes_history.js')}}"></script>
