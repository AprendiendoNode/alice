            ...
            <table id="table_cxc_fact" name='table_filter_fact' class="table table-striped table-hover table-condensed table-sm">
              <thead>
                <tr class="mini">
                    ...
                    <th class="text-center">De 0 a 30</th>
                    <th class="text-center">De 31 a 60</th>
                    <th class="text-center">De 61 a 90</th>
                    <th class="text-center">De 91 a 120</th>
                    <th class="text-center">De 121 a 150</th>
                    <th class="text-center">De 151 a 180</th>
                    <th class="text-center">> 180</th>            
                    <th class="text-center">1 mes</th>
                    <th class="text-center">2 meses</th>
                    <th class="text-center">> 3 meses</th>
...
@push('scripts')
  ...
  <script src="{{ asset('js/admin/accounting/cxc_history.js?v=1.0')}}"></script>
  @else
  @endif
@endpush
