        ...
        <div class="col-md-12">
          <div class="card border-0 ">
            <div class="card-body">
              ...
              <form id="questionary" name="questionary" class="needs-validation" action="{{ url('create_questionaryb') }}" method="POST" novalidate>
              @php ($preg = [])
              @php ($data_survey = [])
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      @elseif ($data_question->type_id == '1')
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                          ...
                          <label class="custom-control-label" for="radio{{$position}}{{$loop->iteration}}">
