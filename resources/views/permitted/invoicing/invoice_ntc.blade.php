...
<body>
  ...
  <div  class="header row">
    <div class="">
        ...
        <p>Estatus: <span>{!! \App\Helpers\SalesHelper::statusCustomerCreditNoteComprasHtml($customer_credit_note->status) !!}</span> </p>
    </div>
    <div class="">
      <p class="transparent">-</p>
  ...
  <table id="table_products" width="100%">
    ...
    <tbody>
      @foreach($customer_credit_note->purchaseLine as $result)
          <tr>
  ...
  <table id="table_amounts">
    <tbody>
      ...
      @if($customer_credit_note->purchaseTax->isNotEmpty())
          @foreach($customer_credit_note->purchaseTax as $result)
            <tr>
  ...
  <!--------->
  <br><br>
  <p class="text-center">Este documento es una representación impresa</p>
