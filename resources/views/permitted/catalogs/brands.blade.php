...
@section('content')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <form id="creatbrands" name="creatbrands" class="forms-sample" action=""> <!-- change -->
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  <label for="inputCreatDist" class="col-sm-3 col-form-label">Distribuidor<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required" id="inputCreatDist" name="inputCreatDist" placeholder="Nombre del distribuidor" maxlength="60">
                  </div>
                </div>
                <div class="form-group row">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <form id="editbrands" name="editbrands" class="forms-sample" action=""> <!-- change -->
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  <label for="inputEditDist" class="col-sm-3 col-form-label">Distribuidor<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required" id="inputEditDist" name="inputEditDist" placeholder="Nombre del distribuidor" maxlength="60">
                  </div>
                </div>
                <div class="form-group row">
  ...
  <div class="row">
    <div class="col-md-12 grid-margin-onerem  stretch-card">
      <div class="card">
        <div class="card-body">
          <p class="mt-2 card-title">Esta sección nos permite gestionar las marcas, que podremos utilizar en nuestro proyecto.</p>
          <div class="d-flex justify-content-center pt-3"></div>

          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                <table id="table_brands" name='table_brands' class="table table-striped border display nowrap compact-tab" style="width:100%; font-size: 10px;">
...
@push('scripts')
  ...
  <script src="{{ asset('js/admin/catalogs/brands.js')}}"></script>
