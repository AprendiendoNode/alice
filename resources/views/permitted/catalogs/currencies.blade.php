...
@section('content')
  <!-- Crear -->
  <div id="modal-CreatNew" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalcurrencies" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="modalcurrencies">Crear moneda</h4>
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <form id="creatcurrencies" name="creatcurrencies" class="forms-sample" action="">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  <label for="inputCreatDecimal" class="col-sm-3 col-form-label">Decimales <span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required onlynumber" id="inputCreatDecimal" name="inputCreatDecimal" placeholder="{{ trans('message.decimal') }}" maxlength="60">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputCreatSymbol" class="col-sm-3 col-form-label">Simbolo <span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required" id="inputCreatSymbol" name="inputCreatSymbol" placeholder="{{ trans('message.simbolo') }}" maxlength="60">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="select_one" class="col-sm-3 col-form-label">Posición del simbolo<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <select  id="select_one" name="select_one" class="form-control form-control-sm required"  style="width: 100%;">
                      <option value="">{{ trans('message.selectopt') }}</option>
                      @forelse ($list_symbol_position as $key => $value)
                ...
                <div class="form-group row">
                  <label for="inputCreatMark" class="col-sm-3 col-form-label">Marca decimal<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required" id="inputCreatMark" name="inputCreatMark" placeholder="{{ trans('message.simbolo') }}" maxlength="60">
                  </div>
                </div>
                <div class="form-group row">
  ...
  <!-- Editar -->
  <div id="modal-Edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modaleditcurrencies" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="modaleditcurrencies">Editar</h4>
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <form id="editcurrencies" name="editcurrencies" class="forms-sample" action="">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  <label for="inputEditDecimal" class="col-sm-3 col-form-label">Decimales <span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required onlynumber" id="inputEditDecimal" name="inputEditDecimal" placeholder="{{ trans('message.decimal') }}" maxlength="60">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEditSymbol" class="col-sm-3 col-form-label">Simbolo <span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required" id="inputEditSymbol" name="inputEditSymbol" placeholder="{{ trans('message.simbolo') }}" maxlength="60">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="editposition" class="col-sm-3 col-form-label">Posición del simbolo<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                ...
                <div class="form-group row">
                  <label for="inputEditMark" class="col-sm-3 col-form-label">Marca decimal<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required" id="inputEditMark" name="inputEditMark" placeholder="{{ trans('message.simbolo') }}" maxlength="1">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEditThousands" class="col-sm-3 col-form-label">Separador de miles<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control form-control-sm required" id="inputEditThousands" name="inputEditThousands" placeholder="Orden de visualización"  maxlength="1">
                  </div>
                </div>
                <div class="form-group row">
  ...
  <div class="row">
    <div class="col-md-12 grid-margin-onerem  stretch-card">
      <div class="card">
        <div class="card-body">
          <p class="mt-2 card-title">Esta sección nos permite administrar las monedas, que podremos utilizar en nuestro proyecto.</p>
          <div class="d-flex justify-content-center pt-3"></div>

          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                <table id="table_currencies" name='table_currencies' class="table table-striped border display nowrap" style="width:100%; font-size: 10px;">
                  <thead>
                    <tr>
                      <th>Nombre</th>
                      <th>Clave</th>
...
@push('scripts')
  ...
  <script src="{{ asset('js/admin/catalogs/currencies.js')}}"></script>
