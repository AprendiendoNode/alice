...
@section('content')
  ...
  <!-- Editar -->
  <div id="modal-Edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modaleditstates" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="modaleditstates">Editar pais</h4>
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <form id="editstates" name="editstates" class="forms-sample" action="">
                {{ csrf_field() }}
                ...
                <div class="form-group row">
                  <label for="edit_select_one" class="col-sm-3 col-form-label">Pais<span style="color: red;">*</span></label>
                  <div class="col-sm-9">
  ...
  <div class="row">
    <div class="col-md-12 grid-margin-onerem  stretch-card">
      <div class="card">
        <div class="card-body">
          <p class="mt-2 card-title">Esta sección nos permite gestionar los estados, que podremos utilizar en nuestro proyecto.</p>
          <strong>Nota:</strong>
          <span class="text_content">Si necesitas añadir un nuevo estado, debes de consultar el siguiente hipervínculo del sat, para obtener la informacion correcta antes de registrar en el sistema.</span>
          ...
          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                <table id="table_states" name='table_states' class="table table-striped border display nowrap" style="width:100%; font-size: 10px;">
                  <thead>
                    <tr>
                      <th>Nombre</th>
                      <th>Pais</th>
...
@push('scripts')
  ...
  <script src="{{ asset('js/admin/catalogs/states.js')}}"></script>
