...
@section('content')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-12">
              <form id="editcategories" name="editcategories" class="forms-sample" action=""> <!-- change -->
                {{ csrf_field() }}
  ...
  <div class="row">
    <div class="col-md-12 grid-margin-onerem  stretch-card">
      <div class="card">
        <div class="card-body">
          <p class="mt-2 card-title">Esta sección nos permite gestionar las categorías, que podremos utilizar en nuestro proyecto.</p>
          <div class="d-flex justify-content-center pt-3"></div>

          <div class="row">
            <div class="col-12">
              <div class="table-responsive">
                <table id="table_categories" name='table_categories' class="table table-striped border display nowrap compact-tab" style="width:100%; font-size: 10px;">
...
@push('scripts')
  ...
  <script src="{{ asset('js/admin/catalogs/categories.js')}}"></script>
