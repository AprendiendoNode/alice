                      ...
                      <form id="validation" name="validation" class="form-horizontal" method="POST">
                          ...
                          <div class="row py-2">
                            <div class="col-md-6">
                              ...
                              <div class="form-group py-2 hide" id="template_cc">
                                ...
                                <div class="form-group py-2">
                                  ...
                                  <div>
                                    <input class="form-control" type="text" id="purchase_order" name="purchase_order" value="" placeholder="Required">
                                  </div>
                                </div>
                                <div class="form-group has-feedback py-2">
                                  ...
                                  <div class="dateContainer">
                                      <div class="input-group input-append date" id="limitDatePicker" name="limitDatePicker">
                                          <span class="input-group-addon add-on"><span class="fas fa-calendar-alt fa-3x"></span></span>
                                          <input type="text" class="form-control" name="date_limit" placeholder="01/01/2019">
                                      </div>
                                   </div>
                                </div>
                                <div class="form-group py-2">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group py-2">
                                ...
                                <div class="">
                                  <input class="form-control" type="text" id="factura" placeholder="Required" name="factura" value="">
                                </div>
                              </div>
                              <div class="form-group py-2">
                                <label for="" class="control-label">Monto Total: </label>
                                <div class="">
                                  <input class="form-control monto" value="0" type="text" id="amount" name="amount" value="">
                                </div>
                              </div>
                              <div class="form-group py-2">
                                ...
                                <div class="form-inline py-2">
                                    ...
                                    <input id="iva_format" class="form-control" style="width: 30%;" required readonly type="text" name="iva_format" value="">
                                    ...
                                    <input id="totales_format" name="totales_format" style="width: 30%;" class="form-control" required readonly type="text" name="" value="">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              <textarea id="concept_pay" class="form-control" rows="3" cols="1000" type="text" name="concept_pay" placeholder="Required" value=""></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                      ...
                      <div class="row py-2">
                                ...
                                <div class="input-group" style="width: 80%;">
                                    <label class="input-group-btn">
                                        <span class="btn btn-danger">
                                            ...
                                            <input id="file_pdf" name="file_pdf" type="file" style="display: none;">
                                        </span>
                                      </label>
                                    <input type="text" class="form-control" readonly>
                                  </div>
                        ...
                        <div class="col-md-6">
                          <!--  Datos bancarios  -->
                              ...
                              <div class="form-group py-2">
                                ...
                                <input type="text" class="form-control" data-currency="0" id="clabe" name="clabe" placeholder="{{ trans('pay.clabe_int') }}" disabled>
                              </div>
                              <div class="form-group py-2">
                        ...
                        <div class="row">
                          <div class="form-group">
                            ...
                            <textarea style="resize:none;" class="form-control" id="observaciones" name="observaciones" placeholder="Required" rows="3" cols="1000"></textarea>
                          </div>
                        </div>
                        <br><br><br>
                        <div class="row">
