  ...
  <div class="card">
    ...
    <div class="card__content">
      <div class="card__title">
        ...
        if ($tam > 44){
          $productRec = substr($productFull,0, 44);
          echo $productRec;
      ...
      <button type="button"
         ...
         class="boton rojo agregar-carrito-material">
         Añadir
       </button>
    </div>
  </div>
...
<script type="text/javascript" src="{{asset('js/admin/documentp/carrito_materiales.js')}}"></script>
