  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class=" mb-2">
          ...
          <div class="form-row d-flex align-items-center mb-2">
            ...
            <div class="col-4 col-md-2 input-group">
              <input readonly id="percent_comission_itc" value="{{$kickoff_comisiones->percent_itc}}" onblur="calcularComision(this);" type="number" class="form-control form-control-sm text-right" min="0" max="100" id="inlineFormInputGroup">
              <div class="input-group-prepend">
                <div class="input-group-text form-control-sm text-dark">%</div>
              </div>
            </div>
          ...
          <div class="form-row d-flex align-items-center mb-2">
            ...
            <div class="col-7 col-md-4">
              <select readonly id="vendedor" name="vendedor" type="text" class="form-control form-control-sm">
            ...
            <div class="col-4 col-md-2 input-group">
              <input readonly id="percent_comision_vendedor" onblur="calcularComision(this);" type="number" class="form-control form-control-sm text-right" min="0" max="100" id="inlineFormInputGroup" value="{{$kickoff_comisiones->percent_vendedor}}">
              <div class="input-group-prepend">
                <div class="input-group-text form-control-sm text-dark">%</div>
              </div>
            </div>
          ...
          <div class="form-row d-flex align-items-center mb-2">
            ...
            <div class="col-7 col-md-4">
              <select readonly id="colaborador" name="colaborador" type="text" class="form-control form-control-sm">
            ...
            <div class="col-4 col-md-2 input-group">
              <input readonly id="percent_colaborador" onblur="calcularComision(this);" type="number" class="form-control form-control-sm text-right" min="0" max="100" id="inlineFormInputGroup" value="{{$kickoff_comisiones->percent_colaborador}}">
              <div class="input-group-prepend">
                <div class="input-group-text form-control-sm text-dark">%</div>
              </div>
            </div>
          ...
          <div class="form-row d-flex align-items-center mb-2">
            ...
            <div class="col-4 col-md-2 input-group">
              <input readonly id="percent_externo1" onblur="calcularComision(this);" type="number" class="form-control form-control-sm text-right" min="0" max="100" id="inlineFormInputGroup" value="{{$kickoff_comisiones->percent_externo1}}">
              <div class="input-group-prepend">
                <div class="input-group-text form-control-sm text-dark">%</div>
              </div>
            </div>
          ...
          <div class="form-row d-flex align-items-center mb-2">
            ...
            <div class="col-4 col-md-2 input-group">
              <input readonly id="percent_externo2" onblur="calcularComision(this);" type="number" class="form-control form-control-sm text-right" min="0" max="100" id="inlineFormInputGroup" value="{{$kickoff_comisiones->percent_externo2}}">
              <div class="input-group-prepend">
                <div class="input-group-text form-control-sm text-dark">%</div>
              </div>
            </div>
      ...
      <div class="modal-footer">
          <h5 class="text-danger">*No tienes permiso para editar comisiones</h5>
