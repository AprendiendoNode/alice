        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="form-group fields_docp">
            <label for="fecha" class="">Densidad</label>
              <input value="1" min="1" type="number" class="form-control form-control-sm" id="densidad" name="densidad">
          </div>
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" id="plazo" name="plazo" value="0">
          </div>
          <div class="form-group">
            <label for="instalaciones" class="control-label">Instalaciones (%)</label>
            <input type="text" class="form-control form-control-sm" id="instalaciones" name="instalaciones" value="0" max="100" min="0">
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
            <label for="doc_type" class="control-label">Servicio Mensual USD</label>
            <input type="text" class="form-control form-control-sm" id="servicio" name="servicio" value="0">
          </div>
          <div class="form-group fields_docp">
            <label for="proyecto" class="control-label">Depósito en garantía</label>
            <input type="number" class="form-control form-control-sm" id="deposito" name="deposito" value="0">
          </div>
        ...
        <div class="col-md-2">
          ...
          <div class="form-group fields_docp">
            ...
            <input type="number" class="form-control form-control-sm" id="renta" name="renta" value="0">
          </div>
          <div class="form-group">
            <label for="utilidad" class="control-label">Utilidad venta EA %</label>
            <input type="number" class="form-control form-control-sm" id="utilidad" name="utilidad" value="0" max="100" min="0">
          </div>
        </div>
        <div class="col-md-2">
          <div class="form-group">
            <label for="type_service" class="control-label">Enlace (USD)</label>
            <input type="number" class="form-control form-control-sm" id="enlace" name="enlace" value="0">
          </div>
          <div class="form-group fields_docp">
            <label for="indirectos" class="control-label">Indirectos %</label>
            <input type="number" class="form-control form-control-sm" id="indirectos" name="indirectos" value="0" max="100" min="0">
          </div>
        </div>
        <div class="col-md-2">
          <div class="form-group">
