                  ...
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                    ...
                    <label>Total: </label><h4>{{$totales[0]->suma_monto}}</h4><br>
                      ...
                      <table class="greyGridTable">
                        ...
                        <th> <small>Beneficiario</small> </th>
                        <th> <small>Elaboro</small> </th>
                        <th> <small>Reviso</small> </th>
                        <th> <small>Aprobo</small> </th>
                        <th> <small>Autorizo</small> </th>
                        <th> <small>Confirmo pago</small> </th>
                        ...
                        <tr>
                          <td>{{ $param[$i]->folio }}</td>
                          <td>{{ $param[$i]->service }}</td>
                          <td>{{ $param[$i]->beneficiary }}</td>
                          <td>{{ $param[$i]->elaboro }}</td>
                          <td>{{ $param[$i]->reviso }}</td>
                          <td>{{ $param[$i]->aprobo }}</td>
                          <td>{{ $param[$i]->autorizo_pago }}</td>
                          <td>{{ $param[$i]->confirmo_pago }}</td>
                          <td>{{ $param[$i]->monto }}</td>
                        </tr>
                        @endfor
