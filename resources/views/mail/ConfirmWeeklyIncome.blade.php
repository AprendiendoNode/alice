              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                    <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;">Ingresos confirmados.</h1>
                    ...
                    <label>Total MXN: </label><h4>{{$totales[0]->sum_MXN}}</h4><label> Total USD: </label><h4>{{$totales[0]->sum_USD}}</h4><br>
                      ...
                      <table class="greyGridTable">
                        ...
                        <th> <small>ID Contrato</small> </th>
                        <th> <small>Mes de pago </small> </th>
                        <th> <small>Moneda</small> </th>
                        <th> <small>Subtotal</small> </th>
                        <th> <small>Mensualidad c/iva</small> </th>
                        <th> <small>Fecha de cobro</small> </th>
                        <th> <small>Semana de cobro</small> </th>
                        ...
                        <tr>
                          <td>{{ $param[$i]->cxclassification }}</td>
                          <td>{{ $param[$i]->vertical }}</td>
                          <td>{{ $param[$i]->cadena }}</td>
                          <td>{{ $param[$i]->key }}</td>
                          <td>{{ $param[$i]->pay_date }}</td>
                          <td>{{ $param[$i]->currencie }}</td>
                          <td>{{ $param[$i]->subtotal }}</td>
                          <td>{{ $param[$i]->mensualidad_civa }}</td>
                          <td>{{ $param[$i]->fecha_cobro_date }}</td>
                          <td>{{ $param[$i]->fecha_cobro_semana }}</td>
