                  ...
                  <tr>
                      <td style="padding: 35px;">
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  line-height: 1.5em;
                                  font-size: 12px;
                                  text-align: left;">Estimado(a) <strong> {{$msg['nombre']}}</strong></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  <a href="{{'http://localhost:8000/questionary/' . $msg['shell_data']}}" target="_blank">Contesta la pregunta aquí.</a></p>
