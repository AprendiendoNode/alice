              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                    <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;">Solicitud de compra aprobada</h1>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Fecha de aprobación: <strong>{{$param['fecha_aprobacion']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Proyecto: <strong>{{$param['nombre_proyecto']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Estimado (a) <strong>{{$param['itc']}}</strong> tu solicitud de compra a sido aprobada</p>
                    ...
                    <p style="margin-top: 0;
                               ...
                               text-align: left;
                               font-size: 14px;
                               text-align: left;"><strong>* Tienes un límite de 3 ediciones para realizar modificaciones.</strong> </p>
                    ...
                    <p style="margin-top: 0;
                               ...
                               text-align: left;
                               font-size: 14px;
                               text-align: left;"><strong>* A partir de tu segunda edición dispondras de un tiempo de 4 horas para enviar una última edición.</strong> </p>
