              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                    <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;">Confirmación de alta de equipo.</h1>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Fecha de registro: <strong>{{$equipment['Fecha_registro']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Dado de alta por: <strong>{{$equipment['User']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Descripción: <strong>{{$equipment['Descripcion']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Especificación: <strong>{{$equipment['Especificacion']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">MAC: <strong>{{$equipment['MAC']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Serie: <strong>{{$equipment['Serie']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Modelo: <strong>{{$equipment['Modelo']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Estado: <strong>{{$equipment['Estado']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Sitio: <strong>{{$equipment['Hotel']}}</strong></p>
