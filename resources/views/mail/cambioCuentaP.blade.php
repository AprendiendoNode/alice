...
<title>Datos de Inserción.</title>
<style type="text/css">
img {
max-width: 20%;
}
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                  <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                    <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;">Nueva cuenta insertada.</h1>
                    ...
                    <p style="margin-top: 20;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">El usuario <strong>{{Auth::user()->name}}, </strong><strong>{{Auth::user()->email}}</strong> agregó una cuenta nueva.</p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Proyecto: <strong>{{$param['proveedor']}}</strong></p>
                    ...
                    <p style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;
                              ...
                              line-height: 1.5em;
                              font-size: 14px;
                              text-align: left;">Sitio:<strong> {{$param['banco']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Proveedor:<strong> {{$param['moneda']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Cuenta:<strong> {{$param['cuenta']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Clabe:<strong> {{$param['clabe']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Referencia: <strong>{{$param['referencia']}}</strong></p>
                    ...
                    <p style="margin-top: 0;
                              ...
                              text-align: left;
                              font-size: 14px;
                              text-align: left;">Fecha de inserción: <strong>{{Carbon\Carbon::now()->toCookieString()}}</strong></p>
