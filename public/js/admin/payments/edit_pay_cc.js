...
function table_history_all(datajson, table) {
  ...
  var vartable = table.dataTable(Configuration_table_responsive_pay_2);
...
var Configuration_table_responsive_pay_2= {
  "order": [[ 1, "asc" ]],
  "select": true,
  ...
  buttons: [
    {
      text: '<i class="fa fa-check margin-r5"></i> Modificar seleccionados',
      titleAttr: 'Modificar seleccionados',
      ...
      action: function ( e, dt, node, config ) {
        ...
        Swal.fire({
          title: "¿Estás seguro?",
          text: "Se modificarán todos los registros seleccionados.!",
          type: "warning",
