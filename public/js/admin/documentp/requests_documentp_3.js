...
function documentp_table(datajson, table){
  ...
  if(data.doc_type == 1){
    ...
    vartable.fnAddData([
      ...
      '<a target="_blank" href="/documentp_invoice/'+ data.id + '/ '+ data.documentp_cart_id +'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Imprimir" role="button"><span class="fa fa-file-pdf-o"></span></a>' +
      ...
      '<a href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="Editar" onclick="editar_cotizador(this)" data-id="' + data.id +'" data-id="' + data.id +'"  data-cart="' + data.documentp_cart_id +'" value="'+data.id+'" class="btn btn-info btn-sm"><span class="fa fa-calculator"></span></a>' +
