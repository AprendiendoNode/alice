$(function() {
  ...
  .on('success.form.fv', function(e) {
        ...
        $.ajax({
          type: "POST",
          url: "/integration/grouping_code_create",
          data: formData,
          contentType: false,
          processData: false,
              ...
              Swal.fire({
                ...
                Swal.fire({
                  ...
                  if (
                    ...
                    window.location.href = "/integration/grouping_code";
                  }
                });
            }
          },
  ...
  .on('success.form.fv', function(e) {
      ...
      $.ajax({
        type: "POST",
        url: "/integration/grouping_code_store",
        data: formData,
        contentType: false,
        processData: false,
        success: function (data){
...
function generate_table() {
  ...
  $.ajax({
    type: "POST",
    url: "/integration/grouping_code_show",
    data: formData,
    contentType: false,
    processData: false,
    success: function (data){
...
function table_filter(datajson, table){
  ...
  $.each(JSON.parse(datajson), function(index, information){
    vartable.fnAddData([
      '<a href="javascript:void(0);" onclick="edit_record(this)" class="btn btn-primary  btn-sm" value="'+information.id+'"  datas="'+information.Nombre+'"><i class="fas fa-pencil-alt btn-icon-prepend fastable"></i></a>',
      information.Nivel,
...
function edit_record(e) {
  ...
  $.ajax({
      type: "POST",
      url: '/integration/grouping_code_edit',
      ...
      success: function (data) {
        ...
        if (data != []) {
          ...
          $('#inputEditNivel').val(data[0].Nivel);
          $('#inputEditCode').val(data[0].Codigo_agrupador);
          $('#inputEditDesc').val(data[0].Nombre);
