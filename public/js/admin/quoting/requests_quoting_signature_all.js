$(function() {
  ...
  function documentp_table(datajson, table){
    ...
    datareview = datajson.filter(data => data.cotizador_status == 'Firma de contrato');
    $.each(datareview, function(index, data){
      let type_doc = 'C';
      let badge = '<span class="badge badge-primary badge-pill text-white">Firma de contrato</span>';
      let parameters_icon = '';
                  ...
                  if (valores.length === 0){
                    ...
                    Swal.fire({
                      ...
                      if(result.value){
                        ...
                        var status_cotizador = 6 // Estatus "EN-KICKOFF";
