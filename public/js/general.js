...
function getSpanCurrent(val){
  ...
  if (isNaN(val)) {
    ...
    retval = '<span class="label label-success" id="pr">Promotor</span>';
  }else if(val >=7){
    retval = '<span class="label label-warning" id="ps">Pasivo</span>';
  }else if(val >= 0){
    retval = '<span class="label label-danger" id="det">Detractor</span>';
  }else{
    retval = "";
  }
  return retval;
