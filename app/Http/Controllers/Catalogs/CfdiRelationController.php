...
class CfdiRelationController extends Controller
{
    ...
    {
      return view('permitted.catalogs.cfdi_relation');
    }
    ...
    public function create(Request $request)
    {
      $user_id= Auth::user()->id;
       ...
       $result = DB::table('cfdi_relations')
                 ->select('code')
                 ->where([
                     ['code', '=', $code],
                   ])->count();
    ...
    {
      $resultados = DB::select('CALL GetAllCfdiRelationv2 ()', array());
    ...
    public function edit(Request $request)
    {
      ...
      $resultados = DB::select('CALL GetCfdiRelationByIdv2 (?)', array($identificador));
