...
class TaxRegimenController extends Controller
{
    ...
    {
      return view('permitted.catalogs.tax_regimens');
    }
  ...
  $id_received= Crypt::decryptString($request->token_b);
    ...
    {
      $resultados = DB::select('CALL GetTaxRegimenv2 ()', array());
    ...
    public function edit(Request $request)
    {
      ...
      $resultados = DB::select('CALL GetTaxRegimenByIdv2 (?)', array($identificador));
