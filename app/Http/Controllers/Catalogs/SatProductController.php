...
class SatProductController extends Controller
{
    ...
    {
      return view('permitted.catalogs.sat_product');
    }
    ...
    {
      $resultados = DB::select('CALL GetSatProductv2 ()', array());
    ...
    public function edit(Request $request)
    {
      ...
      $resultados = DB::select('CALL GetSatProductByIdv2 (?)', array($identificador));
