...
class CfdiTypeController extends Controller
{
    ...
    {
      return view('permitted.catalogs.cfdi_types');
    }
  ...
  $id_received= Crypt::decryptString($request->token_b);
    ...
    {
      $resultados = DB::select('CALL GetAllCfdiTypev2 ()', array());
    ...
    public function edit(Request $request)
    {
      ...
      $resultados = DB::select('CALL GetCfdiTypeByIdv2 (?)', array($identificador));
